...
export default function Shipping() {
    ...
    return (
        <Fragment>
            ...
            {/* ✨ FIXED ALIGNMENT: Uses the exact same wrapper class as Login & Payment */}
            <div 
            ...
            >
                {/* ✨ The Steps are now inside the flex container taking 100% width */}
                <div className="w-100">
                    <CheckoutSteps shipping />
                </div>

                {/* ✨ Adjusted Column Size to match Login form width */}
